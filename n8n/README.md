...
> **Horarios y pipeline completo:** Ver `CLAUDE.md` § Pipeline Nocturno
...
| Workflow | Archivo |
|----------|---------|
| Discovery C21 + Remax | `modulo_1/flujo_a_discovery_century21_v1.0.3_FINAL.json` |
| Enrichment LLM | `modulo_1/flujo_b_processing_v3.0.json` |
| Merge Nocturno | `modulo_1/Flujo Merge - Nocturno v1.0.0.json` |
| Verificador ausencias | `modulo_1/flujo_c_verificador_v1.1.0_FINAL.json` |

### Matching + Auditoría (modulo_2) — 3 workflows activos

| Workflow | Archivo |
|----------|---------|
| Matching Nocturno | `modulo_2/matching_nocturno.json` |
| Auditoría Diaria | `modulo_2/auditoria_diaria_sici.json` |
| TC Dinámico Binance | `modulo_2/tc_dinamico_binance.json` |
...
| Workflow | Archivo |
|----------|---------|
| Discovery C21 | `alquiler/flujo_discovery_c21_alquiler_v1.0.0.json` |
| Discovery Remax | `alquiler/flujo_discovery_remax_alquiler_v1.0.0.json` |
| Discovery Bien Inmuebles | `alquiler/flujo_discovery_bien_inmuebles_alquiler_v1.0.0.json` |
| Enrichment LLM | `alquiler/flujo_enrichment_llm_alquiler_v1.0.0.json` |
| Merge | `alquiler/flujo_merge_alquiler_v1.0.0.json` |
| Verificador | `alquiler/flujo_c_verificador_alquiler_v1.0.0.json` |
