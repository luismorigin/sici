-- Migración 163: Reducir filtro antigüedad alquiler de 180 a 150 días
-- Vida mediana real: C21 34d, Remax 73d → 150d = ~2x margen sobre Remax
-- Solo cambia la línea del WHERE: 180 → 150
