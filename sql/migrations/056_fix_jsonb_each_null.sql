-- =====================================================
-- MIGRACION 056: Fix jsonb_each sobre null
-- Fecha: 13 Enero 2026
-- Bug: "cannot call jsonb_each on a non-object"
-- Causa: estado_amenities es null en muchas propiedades
-- =====================================================
-- EJECUTAR EN SUPABASE SQL EDITOR
-- =====================================================

-- Solo actualizar las subqueries de amenities_confirmados y amenities_por_verificar
-- agregando un CASE WHEN para verificar que es un objeto antes de llamar jsonb_each
...
BEGIN
  ...
  SELECT
    ...
    -- FIX: Verificar que estado_amenities es un objeto antes de llamar jsonb_each
    CASE
...
'v2.16: Fix jsonb_each sobre null - verificar que estado_amenities es objeto.
Tambien incluye: excluir Sin zona, usar precio/m2 en posicion_mercado.';

-- Test
SELECT 'Migracion 056 - Test:' as status;
SELECT COUNT(*) as total FROM buscar_unidades_reales('{"zona": "equipetrol", "limite": 100}'::jsonb);
