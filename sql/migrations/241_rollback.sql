-- Rollback de migración 241 — restaura ambas funciones al estado pre-2026-05-07.
-- Solo aplicar si los conteos POST-migración divergen de los PRE:
--   buscar_unidades_simple('{"limite": 500}'::jsonb)   → 323 filas
--   buscar_unidades_simple('{}'::jsonb)                → 323 filas
--   buscar_unidades_alquiler('{"limite": 500}'::jsonb) → 138 filas
--   buscar_unidades_alquiler('{}'::jsonb)              → 50  filas
--
-- Origen: pg_get_functiondef('buscar_unidades_simple') y
-- pg_get_functiondef('buscar_unidades_alquiler') ejecutados el 2026-05-07.
