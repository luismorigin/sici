-- ============================================================================
-- Migración 124: Fix WHERE de buscar_unidades_reales - 300 días para TODOS
-- ============================================================================
-- El WHERE principal aún tenía 730 días para preventa
-- ============================================================================
...
BEGIN
  ...
  WHERE p.es_activa = true
    ...
    -- FIX: Usar es_propiedad_vigente() que ahora es 300 días para TODOS
    AND (
...
DO $$
BEGIN
    RAISE NOTICE 'Migración 124: WHERE ahora usa es_propiedad_vigente() = 300 días para TODOS';
END $$;
