-- ============================================================================
-- MIGRACIÓN 105: Unificar límite días en mercado a 300 para TODOS
-- ============================================================================
-- Fecha: 2 Febrero 2026
-- Propósito: Cambiar de 730d (preventa) / 300d (otros) a 300d PARA TODOS
-- Motivo: Variación de precios hace que datos >300 días no sean confiables
-- Base: Migración 084 (buscar_unidades_reales v2.26)
-- ============================================================================
...
BEGIN
  ...
  WHERE p.es_activa = true
    ...
    -- ANTES: preventa 730 días, otros 300 días
    -- AHORA: 300 días para todos (variación precios hace datos viejos no confiables)
    -- ========================================================================
    AND (
...
COMMENT ON FUNCTION buscar_unidades_reales IS 'v2.30: Límite unificado 300 días para TODOS los estados de construcción';
