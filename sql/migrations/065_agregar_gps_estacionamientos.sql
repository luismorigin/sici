  -- =====================================================
  -- MIGRACION 065: Agregar GPS y estacionamientos
  -- Fecha: 19 Enero 2026
  -- Propósito: Datos para mobile-first UI (ubicación + parqueos)
  -- =====================================================

  -- Necesario porque cambiamos el RETURNS TABLE (agregamos columnas)
  ...
  RETURNS TABLE (
    ...
    -- v2.22: Nuevos campos para mobile-first UI
    latitud NUMERIC,
    longitud NUMERIC,
  ...
  'v2.22: Agrega latitud, longitud, estacionamientos para UI mobile-first.
  Campos MOAT completos + filtros confianza.';

-- Test
SELECT 'Migracion 065 - Test GPS y estacionamientos:' as status;
SELECT id, proyecto, latitud, longitud, estacionamientos
