-- ============================================================================
-- Migracion 157: Fix WhatsApp fallback para Remax alquileres
-- ============================================================================
-- Problema: 29 propiedades Remax de alquiler no tienen WhatsApp porque el
-- discovery solo trae nombre del agente, no teléfono. El enrichment LLM
-- extrae el teléfono del data-page y lo guarda en datos_json_enrichment.
-- El RPC necesita buscar ahí como fallback.
-- ============================================================================
...
BEGIN
    ...
    SELECT
        ...
        -- Agente nombre: enrichment > datos_json > discovery
        COALESCE(
        ...
        -- Agente teléfono: enrichment > datos_json
        COALESCE(
            p.datos_json_enrichment->'llm_output'->>'agente_telefono',
            p.datos_json->'agente'->>'telefono'
        )::TEXT,

        -- WhatsApp: whatsapp directo > enrichment telefono > datos_json telefono
        COALESCE(
