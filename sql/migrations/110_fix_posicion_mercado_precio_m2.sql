-- =====================================================
-- MIGRACION 064: Fix calcular_posicion_mercado - usar precio_m2
-- Fecha: 19 Enero 2026
-- Bug: Se pasaba precio_usd (total) en vez de precio_m2
-- =====================================================

-- Solo actualizar la línea del posicion_mercado en la función
...
BEGIN
  ...
  SELECT
    ...
    -- =====================================================
    -- FIX 064: Pasar PRECIO_M2, no precio_usd
    -- =====================================================
...
'v2.21: Fix posicion_mercado - ahora usa precio_m2 correctamente.
Campos MOAT completos + filtros confianza (300/730 días).';

-- Test
SELECT 'Migracion 064 - Test posicion_mercado fix:' as status;
SELECT id, proyecto, precio_usd, precio_m2,
       posicion_mercado->>'diferencia_pct' as diff_pct,
