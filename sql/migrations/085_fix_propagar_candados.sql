-- ============================================================================
-- FIX: Corregir función propagar_proyecto_a_propiedades
-- ============================================================================
-- Problema: campos_bloqueados tiene estructura {campo: {bloqueado: true, ...}}
--           no {campo: true}
-- ============================================================================
...
BEGIN
  ...
  -- Estructura: campos_bloqueados->'estado_construccion'->>'bloqueado' = 'true'
...
DO $$
BEGIN
  RAISE NOTICE '✅ Función propagar_proyecto_a_propiedades corregida para estructura campos_bloqueados';
END $$;
