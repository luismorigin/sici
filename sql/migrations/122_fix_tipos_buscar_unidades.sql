-- ============================================================================
-- Migración 122: Fix tipos de datos en buscar_unidades_reales()
-- ============================================================================
-- Problema: latitud era DOUBLE PRECISION pero en BD es NUMERIC
--           baulera era TEXT pero en BD es BOOLEAN
-- ============================================================================
...
DO $$
BEGIN
    RAISE NOTICE 'Migración 122 completada: tipos de datos corregidos (latitud NUMERIC, baulera BOOLEAN)';
END $$;
