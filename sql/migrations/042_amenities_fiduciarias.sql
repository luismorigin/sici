-- =====================================================
-- MIGRACION 042: Amenidades con interpretación fiduciaria
-- Fecha: 12 Enero 2026
-- Propósito: Separar amenidades por nivel de confianza
--            para mostrar confirmadas vs por verificar
-- =====================================================
...
BEGIN
  ...
  SELECT
    ...
    -- =====================================================
    -- v2.9: Amenidades con interpretación fiduciaria
    -- Confirmados: valor=true Y confianza alta/media
    -- Por verificar: valor=por_confirmar O confianza baja
    -- =====================================================
...
'v2.9: Amenidades con interpretación fiduciaria.
- amenities_confirmados: array de amenidades con confianza alta/media y valor=true
- amenities_por_verificar: array de amenidades con confianza baja o valor=por_confirmar
- Permite UI fiduciaria: chips verdes (confirmados) vs grises (por verificar)';

-- =====================================================
-- TEST: Verificar amenidades fiduciarias
-- =====================================================
SELECT 'TEST: Verificar amenidades fiduciarias:' as info;
...
SELECT
  ...
  array_length(amenities_confirmados, 1) as cant_confirmados,
  array_length(amenities_por_verificar, 1) as cant_por_verificar
FROM buscar_unidades_reales('{"limite": 10}'::jsonb)
WHERE amenities_confirmados IS NOT NULL
   OR amenities_por_verificar IS NOT NULL
ORDER BY array_length(amenities_confirmados, 1) DESC NULLS LAST;

SELECT 'Migracion 042 completada - amenidades fiduciarias disponibles' as status;
