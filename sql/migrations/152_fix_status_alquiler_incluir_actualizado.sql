-- ============================================================================
-- Migración 152: Incluir status 'actualizado' en buscar_unidades_alquiler()
-- ============================================================================
-- Bug: Solo 24 propiedades visibles (Remax) porque 145 C21 tienen
--      status = 'actualizado' (post-merge) y el RPC filtraba solo 'completado'.
-- Fix: status IN ('completado', 'actualizado')
-- Resultado: 24 → ~169 propiedades visibles (+ fotos múltiples C21, + WhatsApp)
-- ============================================================================
...
DO $$
BEGIN
    RAISE NOTICE 'Migración 152: Incluir status actualizado en buscar_unidades_alquiler() (24→~169 props)';
END $$;
