-- =====================================================
-- MIGRACION 048: Fix jsonb_each crash on NULL amenities
-- Fecha: 13 Enero 2026
-- Proposito: Evitar error "cannot call jsonb_each on a non-object"
-- cuando estado_amenities es NULL o no existe
-- BASADA EN: migracion 047
-- =====================================================
...
BEGIN
  ...
  SELECT
    ...
    -- FIX 048: Verificar que estado_amenities sea un object ANTES de llamar jsonb_each
    CASE
...
SELECT COUNT(*) as total_1_dorm
FROM buscar_unidades_reales('{"dormitorios": 1, "precio_max": 150000, "solo_con_fotos": true, "limite": 100}'::jsonb);
