-- Fix: buscar_unidades_alquiler — precio_mensual_bob IS NOT NULL → precio_mensual_usd > 0
-- Fecha: 23 Mar 2026
-- Impacto: 1 prop (id 1156) con BOB sin USD deja de aparecer (bug fix)
-- Alinea filtro con v_mercado_alquiler
