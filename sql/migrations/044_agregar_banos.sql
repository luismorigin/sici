-- =====================================================
-- MIGRACIÓN 044: Agregar baños a buscar_unidades_reales
-- Fecha: 12 Enero 2026
-- Propósito: Mostrar cantidad de baños en resultados
-- =====================================================
...
RETURNS TABLE (
  ...
  microzona TEXT,
  dormitorios INTEGER,
  banos NUMERIC,  -- v2.11: Agregar baños
  precio_usd NUMERIC,
  precio_m2 NUMERIC,
  area_m2 NUMERIC,
...
'v2.11: Agregar campo banos a los resultados.';

-- Test
SELECT 'Migración 044 - Test baños:' as status;
SELECT id, proyecto, dormitorios, banos FROM buscar_unidades_reales('{"limite": 5}'::jsonb);
