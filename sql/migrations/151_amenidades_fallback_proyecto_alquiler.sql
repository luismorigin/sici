-- ============================================================================
-- Migración 151: Amenidades fallback desde proyectos_master en alquileres
-- ============================================================================
-- Problema: Solo 8/175 alquileres tienen amenities en datos_json->amenities->lista
-- Solución: Fallback a proyectos_master.amenidades_edificio (96 props más)
-- Cobertura: 8 → 104 propiedades con amenidades visibles
-- ============================================================================
...
DO $$
BEGIN
    RAISE NOTICE 'Migración 151: Amenidades fallback desde proyectos_master (8→104 props)';
END $$;
