-- ============================================================================
-- Migración 125: Agregar fecha_entrega a buscar_unidades_reales()
-- ============================================================================
-- Para mostrar "Preventa - entrega Dic 2025" en vez de "verificar fecha entrega"
-- cuando la fecha está disponible en datos_json
-- ============================================================================
...
RETURNS TABLE(
    ...
    baulera BOOLEAN,
    fecha_entrega TEXT  -- NUEVO: formato 'YYYY-MM' o NULL
)
LANGUAGE plpgsql
AS $function$
BEGIN
  ...
  SELECT
    ...
    -- NUEVO: fecha_entrega desde datos_json
...
DO $$
BEGIN
    RAISE NOTICE 'Migración 125: Agregada fecha_entrega a buscar_unidades_reales()';
END $$;
