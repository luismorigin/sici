-- ============================================================================
-- Migración 148: Fix filtros buscar_unidades_alquiler()
-- ============================================================================
-- Issue 3: "sin zona" invisible al filtrar por zona → agregar manejo sin_zona
-- Issue 4: dormitorios NULL desaparecen al filtrar → incluir NULLs
-- ============================================================================
...
BEGIN
    ...
    WHERE p.es_activa = true
      ...
      -- Filtro: dormitorios (FIX Issue 4: NULL dormitorios siempre pasan)
      AND (
      ...
      -- Filtro: zonas (FIX Issue 3: incluir NULLs cuando sin_zona seleccionado)
      AND (
...
DO $$
BEGIN
    RAISE NOTICE 'Migración 148: Fix filtros alquiler — sin_zona + dormitorios NULL';
END $$;
