-- ============================================================================
-- MIGRACIÓN 082: buscar_unidades_reales() v2.25 - Piso y Forma de Pago
-- ============================================================================
-- Fecha: 2026-01-28
-- Propósito: Agregar campos piso y forma de pago al retorno de la función
-- Dependencia: Migración 081 (columnas en propiedades_v2)
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '════════════════════════════════════════════════════════════════';
  RAISE NOTICE '✅ MIGRACIÓN 082: buscar_unidades_reales v2.25 - Piso y Forma de Pago';
  RAISE NOTICE '════════════════════════════════════════════════════════════════';
  RAISE NOTICE '📋 Función actualizada: %', v_func_exists;
  RAISE NOTICE '📋 Columnas de retorno: %', v_return_cols;
  RAISE NOTICE '';
...
-- ============================================================================
/*
-- Probar que la función retorna los nuevos campos
