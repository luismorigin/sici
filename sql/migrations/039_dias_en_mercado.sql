-- =====================================================
-- MIGRACION 039: Agregar días en mercado a buscar_unidades_reales()
-- Fecha: 12 Enero 2026
-- Propósito: Mostrar cuántos días lleva publicada cada propiedad
...
RETURNS TABLE (
  ...
  -- v2.6: Nuevo campo días en mercado
...
BEGIN
  ...
  SELECT
    ...
    -- =====================================================
    -- v2.6: Días en mercado (desde fecha_publicacion)
    -- =====================================================
...
'v2.6: Agregar dias_en_mercado para interpretación fiduciaria.
- Nuevo campo: dias_en_mercado (CURRENT_DATE - fecha_publicacion)
- Usado en Simón MVP para mostrar tiempo en mercado con interpretación
...
-- =====================================================
-- TEST: Verificar días en mercado
-- =====================================================
SELECT 'TEST: Verificar dias_en_mercado:' as info;

SELECT id, proyecto, dias_en_mercado, precio_usd
FROM buscar_unidades_reales('{"limite": 10}'::jsonb)
ORDER BY dias_en_mercado DESC;

SELECT 'Migracion 039 completada - dias_en_mercado disponible' as status;
