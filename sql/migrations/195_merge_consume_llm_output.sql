-- ============================================================================
-- Migración 195: Merge consume llm_output (Fase C)
--
-- Modifica merge_discovery_enrichment() para leer datos_json_enrichment.llm_output
-- y usarlos en la cadena de prioridad.
--
-- Cambios:
--   1. Nuevas variables para LLM output
--   2. Dormitorios: candado → LLM (confianza alta) → discovery → regex
--   3. Estado construcción: LLM con protección (nunca degrada entrega_inmediata)
--   4. Nombre edificio: LLM como fallback entre regex y existing
--   5. solo_tc_paralelo y es_multiproyecto: LLM directo al UPDATE
--   6. Tracking: fuente 'llm' en cambios_merge
--
-- Versión merge: 2.3.0 → 2.4.0
-- ============================================================================
