-- =====================================================
-- MIGRACION 068: Agregar baulera a buscar_unidades_reales
-- Fecha: 20 Enero 2026
-- Propósito: Exponer columna baulera en MVP
-- =====================================================

-- Necesario porque cambiamos el RETURNS TABLE
...
'v2.23: Agrega columna baulera para MVP.
Campos MOAT completos + filtros confianza.';

-- Test
SELECT 'Migracion 068 - Test baulera:' as status;
SELECT id, proyecto, estacionamientos, baulera
