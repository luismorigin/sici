-- =====================================================
-- MIGRACION 040: Comparación dentro del edificio
-- Fecha: 12 Enero 2026
-- Propósito: Mostrar posición de precio de una propiedad
--            respecto a otras unidades del mismo edificio
--            para interpretación fiduciaria en Simón MVP
-- =====================================================
...
BEGIN
  ...
  -- v2.7: Stats por edificio (para comparación de precios)
  edificio_stats AS (
    SELECT
      pv.id_proyecto_master,
  ...
  SELECT
    ...
    -- Posición de precio (1 = más barata)
    (SELECT COUNT(*) + 1
...
'v2.7: Comparación dentro del edificio.
- Nuevos campos: unidades_en_edificio, posicion_precio_edificio, precio_min_edificio, precio_max_edificio
- Permite mostrar "La más barata de X unidades" con interpretación fiduciaria
...
-- =====================================================
-- TEST: Verificar comparación edificio
-- =====================================================
SELECT 'TEST: Verificar comparación edificio:' as info;
...
ORDER BY proyecto, posicion_precio_edificio;

SELECT 'Migracion 040 completada - comparación edificio disponible' as status;
