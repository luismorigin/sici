-- Migration 213: Add proyecto filter to buscar_unidades_alquiler
-- Allows filtering alquileres by building/project name (ILIKE on nombre_edificio and pm.nombre_oficial)
-- Same pattern as buscar_unidades_simple (line 240-241)
