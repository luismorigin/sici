-- =============================================================================
-- Migración 092: Fix verificación de campos bloqueados en propagación
-- =============================================================================
-- Problema 1: campos_bloqueados puede ser:
--   - true (formato simple): "amenities": true
--   - objeto (formato nuevo): "amenities": {"bloqueado": true, ...}
--   La función solo verificaba el formato objeto.
--
-- Problema 2: jsonb_array_elements_text falla si el valor no es un array
-- =============================================================================
...
BEGIN
  ...
  -- =========================================================================
  -- PROPAGAR AMENIDADES (CORREGIDO v2.1)
  -- Maneja correctamente campos_bloqueados en ambos formatos
  -- y verifica que amenidades_anteriores sea un array válido
  -- =========================================================================
...
v2.1: Corregido para verificar campos_bloqueados en ambos formatos (true y {bloqueado:true})
     y manejar amenidades_anteriores que no sean arrays válidos.
