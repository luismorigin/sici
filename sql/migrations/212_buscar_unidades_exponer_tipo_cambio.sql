...
-- ============================================================================
-- Exportada con pg_get_functiondef() el 14 Abr 2026.
-- UNICO CAMBIO: agregado tipo_cambio_detectado al RETURNS TABLE y al SELECT.
-- DROP necesario porque Postgres no permite cambiar return type con REPLACE.
-- ============================================================================
...
BEGIN
  ...
  SELECT
    ...
    -- NUEVO: tipo_cambio_detectado para que Advisor flagee TC no confirmado
