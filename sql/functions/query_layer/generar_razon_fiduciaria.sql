-- ============================================================================
-- generar_razon_fiduciaria(p_propiedad_id INTEGER)
-- Canonical export from production — 27 Feb 2026
-- ============================================================================
-- EL MOAT: genera razones contextuales con DATA real para cada propiedad.
-- Tipos: escasez, precio_bajo, precio_premium, precio_m2_bajo,
--        mejor_precio_proyecto, top_precio_proyecto, unico, escasez_tipologia,
--        desarrollador.
-- Usa precio_normalizado() + v_metricas_mercado view.
