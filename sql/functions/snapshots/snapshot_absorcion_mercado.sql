...
-- Loop 0-3 dorms: calcula absorción, precios (promedio/mediana/p25/p75),
-- USD/m², área, absorbidas 30d, nuevas 30d, alquiler mensual, ROI cruzado.
-- Inserta en market_absorption_snapshots (idempotente ON CONFLICT).
