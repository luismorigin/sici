...
- 🔁 **4ª señal — SLUG REESCRITO por el portal** (PR #64, 4-ago-2026). C21 reescribe el slug de
  ...
  `🔁 N con SLUG REESCRITO por el portal`. **NO se filtran: se capturan** (el precio nuevo es el vigente).
...
(`dedup_por='cargador_slug_reescrito'`). Imprime `🔁 slug reescrito por el portal: N/M viejas marcadas...`.
