# Equipetrol Baseline — Narrativa editorial (Mayo 2026)
...
## hero.eyebrow
Análisis del mercado para desarrolladoras e inversores · Santa Cruz, Bolivia

## hero.title
{{zonaLabel}} no es una zona.<br>Son {{zonasCount}}.

## hero.subtitle
{{totalVenta}} listings de venta y {{totalAlquiler}} de alquiler portal-observables en {{zonaLabel}} al {{fechaCorte}}, desagregados por submercado, tipología, fase de obra y antigüedad. Edición actualizada al {{fechaCorte}}.

## hero.foot
**{{edicion}}** · Actualización
...
[
  ...
  {"edicion": "04", "fecha": "Enero 2027", "incorpora": "Primera serie longitudinal de precios año-sobre-año. Capítulo de dinámica 2026 completo. Comparativa período a período."}
]
