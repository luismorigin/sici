...
> **Estado: PLAN — mockup validado por el founder (22-jul-2026), sin implementar.**
...
> *"le pareció imposible sacar un dato rápido"*. Diagnóstico: las páginas están construidas como
> **artículos para Google** (Schema.org Article/Dataset/FAQPage) — el humano quedó en segundo plano.
> Además las tablas desbordan el viewport (+41px ventas, +71px alquileres → franja blanca y
...
### Fase 0 · Decisión de URLs (founder, 5 min)
...
### Fase 1 · Capa de datos (~medio día)
...
`components/mercado/` → HeroKPI, KpiGrid, SerieChart (toggle moneda), TipologiaDrill, ZonasBars,
LecturaBox. Brand tokens v1.4. **Al morir las tablas muere el desborde horizontal** (el bug de la
franja blanca se arregla gratis — era la única causa).

### Fase 3 · Preservar el SEO (~2 h)
...
### Fase 4 · Medición + verificación (~2 h)
