# Estudio de Mercado — Condado VI Plaza Italia
...
> Informe de mercado para toma de decisiones comerciales sobre las unidades disponibles de Condado VI Plaza Italia en Equipetrol Centro, Santa Cruz de la Sierra.

---

## PARTE 1 — Mercado Equipetrol Completo
...
| Zona | Feb 2026 Uds | Mar 2026 Uds | Delta | Feb Mediana | Mar Mediana | Delta $/m² |
|------|-------------|-------------|-------|-------------|-------------|-----------|
| Eq. Centro | 124 | 123 | -1 | $2,087 | $2,114 | +$27 (+1.3%) |
| Sirari | 46 | 53 | +7 | $2,063 | $2,036 | -$27 (-1.3%) |
| Eq. Oeste | 31 | 33 | +2 | $1,753 | $2,107 | +$354 (+20.2%) |
| V. Brígida | 38 | 46 | +8 | $1,905 | $1,959 | +$54 (+2.8%) |
| Eq. Norte | 23 | 25 | +2 | $2,387 | $2,420 | +$33 (+1.4%) |

**Nota:** Eq. Oeste muestra salto significativo en mediana por cambio en composición del inventario (nuevos listings premium). TC pasó de Bs 9.33 a Bs 9.454 (+1.3%).

### 1.4 Distribución por Estado de Construcción

| Zona | Entrega Inmediata | Preventa | Nuevo a Estrenar | No Especificado |
|------|-------------------|----------|-------------------|-----------------|
| **Eq. Centro** | 49 (40%) | 35 (28%) | 11 (9%) | 28 (23%) |
| **Sirari** | 23 (43%) | 20 (38%) | 1 (2%) | 9 (17%) |
| **Eq. Oeste** | 21 (64%) | 6 (18%) | 1 (3%) | 5 (15%) |
| **V. Brígida** | 21 (46%) | 7 (15%) | 6 (13%) | 12 (26%) |
| **Eq. Norte** | 15 (60%) | 4 (16%) | 0 | 6 (24%) |

**Insights:**
- Eq. Oeste y Eq. Norte tienen mayor proporción de entrega inmediata (60-64%)
- Sirari mantiene fuerte pipeline de preventa (38%)
- Eq. Centro está balanceado entre entrega inmediata y preventa
- Condado VI compite en el segmento de **entrega inmediata** de Eq. Centro (49 unidades)

### 1.5 Actividad Reciente

| Zona | Activos | Bajas Recientes |
|------|---------|----------------|
| Eq. Centro | 123 | 38 |
| Sirari | 53 | 17 |
| Eq. Oeste | 33 | 6 |
...
**Nota:** "Bajas" = listings que pasaron a `inactivo_pending` recientemente. Pueden ser ventas, retiros de broker, o fin de exclusividad. Eq. Centro tiene la mayor rotación absoluta (38 bajas), lo que indica un mercado activo.

---

## PARTE 2 — Zoom Equipetrol Centro

### 2.1 Resumen Eq. Centro
...
| **Nano Smart** | 3 | $2,415 | $2,446 | 1, 2D | Entrega/Nuevo | $92K-$153K |
| **Edificio Spazios** | 3 | $2,374 | $2,574 | 1, 2, 3D | Nuevo | $110K-$425K |
| **Klug** | 3 | $2,216 | $2,115 | 1, 2D | Mixto | $135K-$156K |

#### Segmento Mercado ($1,800-$2,200/m²) — **COMPETENCIA DIRECTA DE CONDADO VI**

| Proyecto | Uds | $/m² Avg | Mediana | Tipologías | Estado | Ticket Rango |
|----------|-----|----------|---------|------------|--------|-------------|
| **Domus Infinity** | 3 | $2,179 | $2,335 | 1, 2D | Preventa | $88K-$190K |
| **Atrium** | 10 | $2,077 | $2,017 | 1, 2D | Entrega inmed. | $99K-$213K |
...
**Proyectos con movimiento (vs Feb 2026):**
- **Condado VI:** 2 bajas detectadas (ID 174 en Feb, ID 427 en Feb) — posibles ventas
- **Eq. Centro total:** 38 bajas recientes — mercado con rotación activa

**Proyectos estancados (mismo inventario desde Feb):**
- **Atrium:** Pasó de 7-9 a 10 unidades. Sumó listings, no vendió.
- **HH Once:** 8 unidades estables en preventa — absorción lenta
- **HH Chuubi:** 5 unidades en preventa — sin movimiento visible

**Señal de mercado:** Los proyectos de entrega inmediata con buen equipamiento están rotando. Los de preventa sin diferenciación están estancados.

---

## PARTE 3 — Posicionamiento Condado VI

### 3.1 Estado Actual del Inventario Condado (todos los edificios)

| ID | Proyecto | Dorms | Área m² | Precio USD | $/m² | TC | Estado | Status |
|----|----------|-------|---------|-----------|------|-----|--------|--------|
...
Comparación con proyectos de entrega inmediata en Eq. Centro, segmento mercado:
...
| **Klug** | 3 | $2,115 | 1, 2D | Mixto | Buen diseño |
| **Atrium** | 10 | $2,017 | 1, 2D | Entrega inmed. | Mayor inventario |
...
| Proyecto | Unidades en Portal | Inventario Estimado Real | Precio Rango |
|----------|-------------------|-------------------------|-------------|
| **Atrium** | 10 | 10+ | $99K-$213K |
| **HH Once** | 8 | 8+ | $77K-$147K |
| **Sky Tower** | 7 | 7+ | $90K-$206K |
...
*Generado por SICI (Sistema Inteligente de Captura Inmobiliaria) — Marzo 2026*
*Datos verificados con GPS y normalización de TC. Precios en USD billete.*
