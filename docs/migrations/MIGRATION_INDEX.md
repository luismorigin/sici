...
> **Nota migraciones SHADOW (269-282):** las migraciones del entorno shadow (deptos híbrido) viven en los worktrees de sus ramas (`hybrid-worktree-structure-3b7b53` para 268-280; `session-context-e0ffd1` para 281/282). Se renumeran/consolidan en el cutover shadow→prod. En este índice solo figuran las que ya están en el árbol principal (276) + las de esta rama (281/282).
